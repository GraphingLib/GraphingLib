...
class TestScatter(unittest.TestCase):
    ...
    def test_subtract_scatter_with_int(self):
        ...
        self.assertIsInstance(scatter_sub, Scatter)
        self.assertAlmostEqual(
            scatter_sub.get_point_at_x(0).y,
            2 - self.testScatter.get_point_at_x(0).y,
            places=3,
        )
        self.assertAlmostEqual(
            scatter_sub.get_point_at_x(2).y,
            2 - self.testScatter.get_point_at_x(2).y,
            places=3,
        )
    ...
    def test_divide_scatter_with_int(self):
        ...
        self.assertIsInstance(scatter_div, Scatter)
        self.assertAlmostEqual(
            scatter_div.get_point_at_x(0).y,
            2 / new_scatter.get_point_at_x(0).y,
            places=3,
        )
    ...
    def test_power_with_int(self):
        ...
        self.assertAlmostEqual(scatter_pow.get_point_at_x(0).y, 0, places=3)
        self.assertAlmostEqual(
            scatter_pow.get_point_at_x(2).y,
            self.testScatter.get_point_at_x(2).y ** 2,
            places=3,
        )
